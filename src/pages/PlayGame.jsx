...
function PlayGame({ hint, originalWord, guessedLetters, step, handleLetterClick, onNewSinglePlayerGame }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-100 to-blue-200">
      {/* Game Title */}
      <header className="bg-blue-400 text-white py-6 px-4 shadow-lg">
      ...
      {/* Footer Links */}
      <footer className="bg-blue-300 text-blue-800 py-2 px-4 mt-">
        <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-center sm:text-left">
            <h2 className="text-xl font-semibold mb-2">Choose Your Game Mode</h2>
            <p className="text-black">Challenge yourself or play with friends!</p>
          </div>
...
// export default function Component({ hint, originalWord, guessedLetters, step, handleLetterClick, onNewSinglePlayerGame }) {
//   return (
//     <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-100 to-blue-200">
//       {/* Improved Header */}
